/**
 * Beat the Baseline BFF -> core-api bridge (Spec 0031 §2 GAME-001). Same
 * pattern as the Arena's api/arena/_lib/core-api.ts (Spec 0029 §4):
 * dumbmodel's own workspace key, bearer-authed, server-only.
 */
