/**
 * Rank Arena BFF -> core-api bridge (Spec 0029 §4). Same pattern as
 * dumbmodel's existing api/diagnose route + @synthaembed/ui-fleet's
 * site-api: dumbmodel's own workspace key, bearer-authed, server-only.
 */
