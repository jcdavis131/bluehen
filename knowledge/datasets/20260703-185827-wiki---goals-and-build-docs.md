...
datasetId: 20260703-185827-wiki---goals-and-build-docs
---

# Provenance

Point-in-time collection run `20260703-185827-wiki---goals-and-build-docs` — 3 documents,
8 chunks (sentence strategy,
~2389 tokens). Raw artifacts live at
`data/datalab/20260703-185827-wiki---goals-and-build-docs/` (docs.jsonl, chunks.jsonl, manifest.json);
trace `20260703-185827-5c45b583` in `data/traces/`.
